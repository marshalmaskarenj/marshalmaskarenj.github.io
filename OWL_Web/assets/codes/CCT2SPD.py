"""
CIE other illuminants D: for a given CCT, this component generates relative SPD for various wavelegths between 300-830nm, with a bin size of 5nm. 
The values are relative to 560nm, thus 560 nm refers to a value of 100 (percent). This is derived from CIE 015: 2018.
The input is conected with SpectralSkydome, which takes luminance data from components emulating sky models: CIE or Perez.
For indoor scenes, when a lower luminance threshold is defined in SpectralViewdome, use the other component: viewCCT2SPD.
--
...
self.Name = "SCALE_CCT2SPD"
self.NickName = 'CCT2SPD'
